...
prx.types.actionarea = {
    ...
    ,onDisplay: function(item,containerid,symbol) {
        var _id = (!containerid) ? item.id : containerid+'-'+item.id;
        let assistiveDescripionAttr = item.assistiveDescription ? 'role="button" aria-label="' + item.assistiveDescription + '"' : '';
...
prx.types.image = {
    ...
    , onDisplay: function (item, containerid, symbol) {
        ...
        let ariaAttribute = item.assistiveDescription ? 'role="img" aria-label="' + item.assistiveDescription + '"' : '';
